    ...
    <table class="min-w-full bg-white rounded-lg shadow-md overflow-hidden">
      <thead>
        <tr class="bg-green-600 text-white text-lg font-semibold">
          <th class="py-3 px-6 text-center rounded-tl-lg">Escudo</th>
          <th class="py-3 px-6 text-center">Nombre del equipo</th>
          <th class="py-3 px-6 text-center">Entrenador</th>
          <th class="py-3 px-6 text-center rounded-tr-lg">Color de vestimenta</th>
        </tr>
      </thead>
      <tbody>
        <tr 
        ...
        >
          ...
          <td class="py-4 px-6 text-center">{{ equipo.NombreEquipo }}</td>
          <td class="py-4 px-6 text-center">{{ equipo.NombreEntrenador }}</td>
          <td class="py-4 px-6 text-center">{{ equipo.ColorVestimenta }}</td>
        </tr>
      </tbody>
    </table>
